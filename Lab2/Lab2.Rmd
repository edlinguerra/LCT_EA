---
title: 'Estadística Aplicada. Lab2: Prueba de hipótesis simples'
...
1. Ingresar al espacio de trabajo de **R-Studio Cloud**

2. Noten el *Laboratorio 2* en la lista de proyectos, e inicien el laboratorio (*START*)

3. Una vez dentro del proyecto, cree un archivo de comandos y llámelo MisComandos.R; también abra el archivo MiReporte.Rmd en la carpeta **lab2**

4. Lea los pasos de cada ejercicio en esta actividad y ejecute los comandos que considere desde su archivo de comandos comandos.R. 

5. Las respuesta a las preguntas escríbalas en Mireporte.Rmd. Agregue los comandos definitivos que le permitieron responder la pregunta usando un bloque de código de **R** o **chunk** (lo puede generar con Ctrl + Alt + i). También debe incluir los gráficos en este documento, usando los comandos definitivos en el **chunk**.
